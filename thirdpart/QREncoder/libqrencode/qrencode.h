 ...
 */
extern QRinput *QRinput_new2(long version, QRecLevel level);
 ...
 *
 */
extern long QRinput_append(QRinput *input, QRencodeMode mode, long size, const unsigned char *data);
 ...
 */
extern long QRinput_getVersion(QRinput *input);
 ...
 */
extern long QRinput_setVersion(QRinput *input, long version);
 ...
 */
extern long QRinput_check(QRencodeMode mode, long size, const unsigned char *data);
 ...
 */
typedef struct {
	long version;         ///< version of the symbol
	long width;           ///< width of the symbol
