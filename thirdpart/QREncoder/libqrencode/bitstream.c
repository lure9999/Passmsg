...
static long BitStream_allocate(BitStream *bstream, long length)
{
	unsigned char *data;
...
static BitStream *BitStream_newFromNum(long bits, unsigned long num)
{
	unsigned int mask;
	int i;
	unsigned char *p;
...
static BitStream *BitStream_newFromBytes(long size, unsigned char *data)
{
	unsigned char mask;
	int i, j;
	unsigned char *p;
...
long BitStream_append(BitStream *bstream, BitStream *arg)
{
	unsigned char *data;
...
long BitStream_appendNum(BitStream *bstream, long bits, unsigned long num)
{
	BitStream *b;
	long ret;
...
long BitStream_appendBytes(BitStream *bstream, long size, unsigned char *data)
{
	BitStream *b;
	long ret;
