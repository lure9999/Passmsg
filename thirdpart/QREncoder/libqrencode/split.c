...
static long Split_eatNum(const char *string, QRinput *input, QRencodeMode hint);
static long Split_eatAn(const char *string, QRinput *input, QRencodeMode hint);
static long Split_eat8(const char *string, QRinput *input, QRencodeMode hint);
static long Split_eatKanji(const char *string, QRinput *input, QRencodeMode hint);
