...
struct _QRinput_List {
	QRencodeMode mode;
	long size;				///< Size of data chunk (byte).
...
extern long QRinput_estimateBitsModeNum(long size);
extern long QRinput_estimateBitsModeAn(long size);
extern long QRinput_estimateBitsMode8(long size);
extern long QRinput_estimateBitsModeKanji(long size);
