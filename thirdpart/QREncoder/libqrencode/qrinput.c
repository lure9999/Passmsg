...
static QRinput_List *QRinput_List_newEntry(QRencodeMode mode, long size, const unsigned char *data)
{
	QRinput_List *entry;
...
QRinput *QRinput_new2(long version, QRecLevel level)
{
	QRinput *input;
...
long QRinput_getVersion(QRinput *input)
{
	return input->version;
}

long QRinput_setVersion(QRinput *input, long version)
{
...
long QRinput_append(QRinput *input, QRencodeMode mode, long size, const unsigned char *data)
{
	QRinput_List *entry;
 ...
 * @return result
 */
static long QRinput_checkModeNum(long size, const char *data)
{
	int i;
 ...
 */
long QRinput_estimateBitsModeNum(long size)
{
	long w;
	long bits;
 ...
 * @throw ENOMEM unable to allocate memory.
 */
static long QRinput_encodeModeNum(QRinput_List *entry, long version)
{
	long words, i, ret;
	unsigned long val;
 ...
 * @return result
 */
static long QRinput_checkModeAn(long size, const char *data)
{
	int i;
 ...
 * @return number of bits
 */
long QRinput_estimateBitsModeAn(long size)
{
	long w;
	long bits;
 ...
 * @throw ENOMEM unable to allocate memory.
 */
static long QRinput_encodeModeAn(QRinput_List *entry, long version)
{
	long words, i, ret;
	unsigned long val;
 ...
 * @return number of bits
 */
long QRinput_estimateBitsMode8(long size)
{
	return size * 8;
}
 ...
 * @throw ENOMEM unable to allocate memory.
 */
static long QRinput_encodeMode8(QRinput_List *entry, long version)
{
	long ret, i;
	unsigned long val;
 ...
 * @return number of bits
 */
long QRinput_estimateBitsModeKanji(long size)
{
	return (size / 2) * 13;
}
 ...
 * @return result
 */
static long QRinput_checkModeKanji(long size, const unsigned char *data)
{
	int i;
	unsigned int val;
 ...
 * @throw ENOMEM unable to allocate memory.
 */
static long QRinput_encodeModeKanji(QRinput_List *entry, long version)
{
	long ret, i;
	unsigned long val, h;
...
long QRinput_check(QRencodeMode mode, long size, const unsigned char *data)
{
	if(size <= 0) return -1;
 ...
 * @return number of bits
 */
static long QRinput_estimateBitStreamSizeOfEntry(QRinput_List *entry, long version)
{
	long bits = 0;
	long l, m;
	long num;
 ...
 */
//__STATIC
static long QRinput_estimateBitStreamSize(QRinput *input, long version)
{
	QRinput_List *list;
	int bits = 0;
 ...
 */
static long QRinput_estimateVersion(QRinput *input)
{
	long bits;
	long version, prev;
 ...
 */
//__STATIC
static long QRinput_lengthOfCode(QRencodeMode mode, long version, long bits)
{
	long payload, size, chunks, remain, maxsize;
 ...
 */
static long QRinput_encodeBitStream(QRinput_List *entry, long version)
{
	long words, ret;
 ...
 * @throw ENOMEM unable to allocate memory.
 */
static long QRinput_createBitStream(QRinput *input)
{
	QRinput_List *list;
	long bits, total = 0;
 ...
 * @throw ENOMEM unable to allocate memory.
 */
static long QRinput_appendPaddingBit(BitStream *bstream, QRinput *input)
{
	long bits, maxbits, words, maxwords, i, ret;
...
static long QRinput_List_shrinkEntry(QRinput_List *entry, long bytes)
{
	unsigned char *data;
...
//__STATIC
static long QRinput_splitEntry(QRinput_List *entry, long bytes)
{
	QRinput_List *e;
	long ret;
...
QRinput_Struct *QRinput_splitQRinputToStruct(QRinput *input)
{
	QRinput *p;
	QRinput_Struct *s;
	long bits, maxbits, nextbits, bytes, ret;
