 ...
 */
@property(nonatomic,assign) id<FlickTabViewDelegate> delegate;

/*
 * @see FlickTabViewDataSource protocol
 */
@property(nonatomic,assign) id<FlickTabViewDataSource> dataSource;
...
@property(nonatomic,strong) UIView* leftCap;
@property(nonatomic,strong) UIView* rightCap;
