...
/*--------------TabView Type      --------------------*/
/*------------------------- --------------------------*/
#define TAB_GUANG_YI_GUANG             0  /* 逛一逛 */
#define TAB_MY_COUPON                  1  /* 我的优惠券 */
#define TAB_WEI_TONG_SHE               2  /* 微通社 */
#define TAB_ZHAO_PENG_YOU              3  /* 找朋友 */
#define TAB_GOU_WU_QIANG               4  /* 购物墙 */
#define TAB_GENG_DUO                   5  /* 更多 */
/*------------------------- --------------------------*/
/*--------------user Type      --------------------*/
/*------------------------- --------------------------*/
